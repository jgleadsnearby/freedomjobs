...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Send Ticket" tabIcon="copy"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="My Account" tabIcon="contact"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/tabs/tabs.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__welcome_welcome__ = __webpack_require__(95);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/about/about.html"*/'<ion-header>\n  <ion-navbar>\n    <img ion-right src="assets/imgs/logo.png" class="navbarLogo" />\n    <ion-title>My Account</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <form (ngSubmit)="updateUser()" [formGroup]="form">\n        <ion-list inset>\n\n            <ion-item [ngClass]="{ invalid: nameErrors.hasError(\'*\', [\'touched\']) }">\n                <ion-input type="text" placeholder="Full Name" formControlName="name"></ion-input>\n            </ion-item>\n\n            <div ngxErrors="name" #nameErrors="ngxErrors">\n                <div [ngxError]="[\'name\', \'required\']" [when]="[\'touched\']">It should be a valid name</div>\n            </div>\n\n            <ion-item [ngClass]="{ invalid: employeeErrors.hasError(\'*\', [\'touched\']) }">\n                <ion-input type="text" placeholder="Employee Number" formControlName="employeeNumber"></ion-input>\n            </ion-item>\n\n            <div ngxErrors="employeeNumber" #employeeErrors="ngxErrors">\n                <div [ngxError]="[\'employeeNumber\', \'required\']" [when]="[\'touched\']">It should be a valid employee Number</div>\n            </div>\n\n            <ion-item>\n                <ion-input type="text" placeholder="Email" [readonly]="true" formControlName="email"></ion-input>\n            </ion-item>\n\n        </ion-list>\n\n        <div padding-horizontal>\n            <div class="form-error">{{updateUserError}}</div>\n\n            <button ion-button full type="submit" [disabled]="!form.valid">Update</button>\n        </div>\n    </form>\n\n    <div text-center style="padding-top: 20px">\n            <button ion-button icon-start round (click)="logout()" *ngIf="authProvider.authenticated">\n                <ion-icon name="log-out"></ion-icon>\n                Log out\n            </button>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/about/about.html"*/
        }),
...
var ContactPage = (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/contact/contact.html"*/'<ion-header>\n  <ion-navbar>\n    <img ion-right src="assets/imgs/logo.png" class="navbarLogo" />\n    <ion-title>Contact</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  \n</ion-content>\n'/*ion-inline-end:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/contact/contact.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_common_http__ = __webpack_require__(127);
...
var HomePage = (function () {
    function HomePage(navCtrl, storage, toastCtrl, app, http, loadingCtrl, imagePicker, camera, authProvider) {
        ...
        this.camera = camera;
        this.authProvider = authProvider;
        this.BaseUrl = "https://homeserviceapps.com/jacksons/";
        this.data = {
            'fullName': '',
            'employeeNumber': '',
            'email': '',
    ...
    HomePage.prototype.post = function (url, body) {
        ...
        return this.http.post(this.BaseUrl + url, formData)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authProvider.updateJobs(this.data)];
                    case 1:
                        _a.sent();
                        this.hideLoader();
                        return [2 /*return*/];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_component__ = __webpack_require__(729);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_welcome_welcome__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_storage__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_status_bar__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_splash_screen__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_common_http__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__app_firebase_config__ = __webpack_require__(730);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_angularfire2__ = __webpack_require__(731);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_angularfire2_auth__ = __webpack_require__(234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_angularfire2_database__ = __webpack_require__(332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_auth_auth__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ultimate_ngxerrors__ = __webpack_require__(732);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_image_picker__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_camera__ = __webpack_require__(343);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_16_angularfire2__["AngularFireModule"].initializeApp(__WEBPACK_IMPORTED_MODULE_15__app_firebase_config__["a" /* FIREBASE_CONFIG */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_welcome_welcome__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_auth__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_tabs_tabs__ = __webpack_require__(125);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/app/app.html"*/
        }),
...
var FIREBASE_CONFIG = {
    apiKey: "AIzaSyDZ7HwkBwrZNZ8MSbvH3JMq7rv7NEJSb5s",
    authDomain: "servicepal-5941e.firebaseapp.com",
    databaseURL: "https://servicepal-5941e.firebaseio.com",
    projectId: "servicepal-5941e",
    storageBucket: "",
    messagingSenderId: "323048189412",
    appId: "1:323048189412:web:e4b91ce20737ed08"
};
...
var Login = (function () {
  ...
  */
    ...
    Login = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/login/login.html"*/'<ion-header>\n  <ion-navbar>\n    <img ion-right src="assets/imgs/logo.png" class="navbarLogo" />\n    <ion-title>Login</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <form (ngSubmit)="login()" [formGroup]="loginForm">\n    <ion-list inset>\n\n      <ion-item [ngClass]="{ invalid: emailErrors.hasError(\'*\', [\'touched\', \'dirty\']) }">\n        <ion-input type="text" placeholder="Email" formControlName="email"></ion-input>\n      </ion-item>\n\n      <div ngxErrors="email" #emailErrors="ngxErrors">\n        <div [ngxError]="[\'email\', \'required\']" [when]="[\'touched\', \'dirty\']">It should be a valid email</div>\n      </div>\n\n      <ion-item [ngClass]="{ invalid: passwordErrors.hasError(\'*\', [\'touched\']) }">\n        <ion-input type="password" placeholder="Password" formControlName="password"></ion-input>\n      </ion-item>\n\n      <div ngxErrors="password" #passwordErrors="ngxErrors">\n        <div [ngxError]="[\'minlength\', \'required\']" [when]="[\'touched\']">It should be at least 6 characters</div>\n      </div>\n    </ion-list>\n\n    <div padding-horizontal>\n      <div class="form-error">{{loginError}}</div>\n      <button ion-button full type="submit" [disabled]="!loginForm.valid">Log in</button>\n    </div>\n  </form>\n</ion-content>\n'/*ion-inline-end:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/login/login.html"*/,
        }),
...
var Welcome = (function () {
    ...
    Welcome = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-welcome',template:/*ion-inline-start:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/welcome/welcome.html"*/'\n\n\n<ion-content padding id="welcome">\n\n<img src="assets/imgs/logo.png" class="logo"/>\n<h3>Daily Time and Job Ticket Summary App</h3>\n\n<button ion-button block class="marginTop" (click)="signup()">Signup</button>\n<button ion-button block color="lightprimary" (click)="login()">Login</button>\n</ion-content>\n'/*ion-inline-end:"/Users/admin/Desktop/desktop/jackson-sons-app-master/src/pages/welcome/welcome.html"*/,
        }),
